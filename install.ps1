...
[CmdletBinding()]
param (
  [System.Uri]$ModuleUri = 'https://raw.githubusercontent.com/TheNorthie/dotfiles/main/dot_config/requirements.psd1',
  ...
  [String]$SSHEmail = 'taylor.north@thenorthie.com',
  [String]$SSHUri = 'git@github.com:thenorthie/dotfiles.git',
